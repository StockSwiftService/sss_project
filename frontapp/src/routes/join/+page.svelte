<div class="w100per bsb pt120 pb120 mgc" style="max-width: 480px;">
    ...
    <div class="flex fdc g36 mt60">
        ...
        <div>
            <h2 class="c333 f16 tm mb8">주소<span class="cr f16 tm inblock">*</span></h2>
            <div class="flex g8">
                <div class="input-type-1 w100per">
                    <input type="text" placeholder="주소">
                </div>
                <button class="btn-type-1 w80 f15 bdr4 b333 cfff">찾기</button>
            </div>
        ...
        <div>
            ...
            <div class="flex g8">
                ...
                <button class="btn-type-1 w80 f15 bdr4 b333 cfff">확인</button>
            </div>
            <div class="error-text-box">
                <span class="f13 mt8 cr">필수 입력 항목입니다.</span>
                <span class="f13 mt8 cr">사용하실 수 없는 사업자 번호 입니다.</span>
                <span class="f13 mt8 cg">사용하실 수 있는 사업자 번호 입니다.</span>
            </div>
        </div>
        <div>
            ...
            <div class="flex g8">
                ...
                <button class="btn-type-1 w80 f15 bdr4 b333 cfff">전송</button>
            </div>
            <div class="error-text-box">
                <span class="f13 mt8 cr">필수 입력 항목입니다.</span>
                <span class="f13 mt8 cr">사용하실 수 없는 이메일 입니다.</span>
                <span class="f13 mt8 cg">이메일 인증 번호가 발송되었습니다.</span>
            </div>
            ...
            <div class="error-text-box">
                <span class="f13 mt8 cr">필수 입력 항목입니다.</span>
                <span class="f13 mt8 cr">인증 번호가 일치하지 않습니다.</span>
                <span class="f13 mt8 cg">인증이 완료되었습니다.</span>
            </div>
        </div>
        <div>
        ...
        <div>
            <h2 class="c333 f16 tm mb8">연락처<span class="cr f16 tm inblock">*</span></h2>
            <div class="input-type-1 w100per">

...
public class SalesManagementController {
    ...
    public RsData<CreateSM> CreateSalesM(@RequestBody CreateSalesManagement createSalesManagement){
        ...
        for (Long num : createSalesManagement.getPurchaseId()) {
            List<SalesManagement> salesManagement = saleManagementService.printTotalSales(num);
            salesManagementList.addAll(salesManagement);
        }
        return RsData.of("R-1", "성공", new CreateSM(salesManagementList));
    }
}